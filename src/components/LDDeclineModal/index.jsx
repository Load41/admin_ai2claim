                ...
                modalContent={
                    <>
                        <div className="">
                            ...
                            <Radio.Group onChange={onChange} value={value} className={clsx(styles.declineList, "d-flex flex-column")}>
                                <Radio className="w-100 h5 fw-normal" value={1}>Already taken by the name</Radio>
                                <Radio className="w-100 h5 fw-normal" value={2}>Insufficient Data</Radio>
                                <Radio className="w-100 h5 fw-normal" value={3}>Others</Radio>
                            </Radio.Group>
                            <LDInput isTextarea/>
