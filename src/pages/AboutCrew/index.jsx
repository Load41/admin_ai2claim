...
import { companyOne, companyTwo, manWorkerFive, manWorkerSix, manWorkerThree } from "../../constants/imageData";
     ...
     <div className={clsx("admin-content")}>
      ...
      <div className="w-100 mt-5">
        <div className="d-flex align-items-center gap-2 w-100">
              <h4 className="mb-0">Crew<span className="ps-2">(111)</span></h4>
              <b>{svgIcons.doubleRightArrowIcon}</b>
              <h4 className="mb-0">Harris & Hyde</h4>
        </div>
                    ...
                    <div className="pendingProjectLisRow w-100">
                        <div className={"pendingProjectListLeftCol text-center flex-0-auto"}>
                          <div className="ratio ratio-1x1">
                              <img src={companyTwo} className="img-fluid w-100 h-100 radius-inherit object-fit-cover" alt=""/>
                          </div>
        ...
        <div className="col-md-6">
            ...
            <div className="col-md-6 d-grid about-crew-management-img-grid gap-4">
              ...
              <div className="ratio ratio-16x9">
                <img src={companyOne} className="w-100 h-100 object-fit-cover" alt="" />
              </div>
              <div className="ratio ratio-16x9">
                <img src={companyTwo} className="w-100 h-100 object-fit-cover" alt="" />
              </div>
            </div>
